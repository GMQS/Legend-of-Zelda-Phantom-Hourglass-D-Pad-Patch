...
.macro .ropen, us_original_file, eu_original_file, jp_original_file, us_output_file, eu_output_file, jp_output_file, us_offset, eu_offset, jp_offset
	.if current_region == REGION_US
		.open us_original_file, us_output_file, us_offset
	.elseif current_region == REGION_EU
		.open eu_original_file, eu_output_file, eu_offset
	.elseif current_region == REGION_JP
		.open jp_original_file, jp_output_file, jp_offset
	.endif
.endmacro
...
;Branches depending on game region
.macro rb, us_offset, eu_offset, jp_offset
	.if current_region == REGION_US
		b us_offset
	.elseif current_region == REGION_EU
		b eu_offset
